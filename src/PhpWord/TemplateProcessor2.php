...
use PhpOffice\PhpWord\Shared\ZipArchive2;

class TemplateProcessor2
{
    ...
    public function setValueXML($tag_buscar, $reemplazar, $salto_linea = true)
    {
        $tag_buscar = '<w:p w14:paraId="59F3EADC" w14:textId="77777777" w:rsidR="000F0F0F" w:rsidRDefault="00ED4C00" w:rsidP="00ED4C00"><w:r><w:rPr><w:rFonts w:ascii="Arial" w:hAnsi="Arial" w:cs="Arial"/><w:color w:val="404040" w:themeColor="text1" w:themeTint="BF"/><w:sz w:val="24"/></w:rPr><w:t>${'.$tag_buscar.'}</w:t></w:r></w:p>';
        if ($salto_linea)
        {
            $reemplazar .= '<w:p w14:paraId="59F3EADC" w14:textId="77777777" w:rsidR="000F0F0F" w:rsidRDefault="00ED4C00" w:rsidP="00ED4C00"><w:r><w:rPr><w:rFonts w:ascii="Arial" w:hAnsi="Arial" w:cs="Arial"/><w:color w:val="404040" w:themeColor="text1" w:themeTint="BF"/><w:sz w:val="24"/></w:rPr><w:t> </w:t></w:r></w:p>';
            $this->tempDocumentMainPart = str_replace($tag_buscar, $reemplazar, $this->tempDocumentMainPart);
        } else
            $this->tempDocumentMainPart = str_replace($tag_buscar, $reemplazar, $this->tempDocumentMainPart);
    }
    
    public function setValueXML_LR($tag_buscar, $reemplazar, $salto_linea = true)
    {
        $tag_buscar = '<w:p w:rsidR="000F0F0F" w:rsidRDefault="007531E5" w:rsidP="00ED4C00"><w:r><w:rPr><w:rFonts w:ascii="Arial" w:hAnsi="Arial" w:cs="Arial"/><w:color w:val="404040" w:themeColor="text1" w:themeTint="BF"/></w:rPr><w:t>${'.$tag_buscar.'}</w:t></w:r></w:p>';
        
        if ($salto_linea)
        {
            $reemplazar .= '<w:p w:rsidR="000F0F0F" w:rsidRDefault="00ED4C00" w:rsidP="00ED4C00"><w:r><w:rPr><w:rFonts w:ascii="Arial" w:hAnsi="Arial" w:cs="Arial"/><w:color w:val="404040" w:themeColor="text1" w:themeTint="BF"/><w:sz w:val="24"/></w:rPr><w:t> </w:t></w:r></w:p>';
            $this->tempDocumentMainPart = str_replace($tag_buscar, $reemplazar, $this->tempDocumentMainPart);
        } else
            $this->tempDocumentMainPart = str_replace($tag_buscar, $reemplazar, $this->tempDocumentMainPart);
    }

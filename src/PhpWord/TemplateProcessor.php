...
class TemplateProcessor
{
     ...
     * @var string
     */
    private $temporaryDocumentRels; //ADD FIX
    ...
    public function __construct($documentTemplate)
    {
        ...
        $this->temporaryDocumentRels = $this->zipClass->getFromName('word/_rels/document.xml.rels'); //ADD FIX
    }
    ...
    public function setImageValue($search, $replace){
        ...
        $this->setValue($search.'::width', "300px");
    }
    ...
    public function setValue($search, $replace, $limit = self::MAXIMUM_REPLACEMENTS_DEFAULT)
    {
        ...
        if (is_array($replace)) {
            ...
            $replace = self::ensureUtf8Encoded(preg_replace('~\R~u', '</w:t><w:br/><w:t>', $replace));
        }
    ...
    {
        $tag_buscar = '<w:p w:rsidR="000F0F0F" w:rsidRDefault="00ED4C00" w:rsidP="00ED4C00"><w:r><w:rPr><w:rFonts w:ascii="Arial" w:hAnsi="Arial" w:cs="Arial"/><w:color w:val="404040" w:themeColor="text1" w:themeTint="BF"/><w:sz w:val="24"/></w:rPr><w:t>${'.$tag_buscar.'}</w:t></w:r></w:p>';
        if ($salto_linea)
        {
